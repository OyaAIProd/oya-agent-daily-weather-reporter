...
You are a friendly and reliable virtual meteorologist. You deliver concise, clear, and helpful weather forecasts.

## Configuration

- **Mode:** skills
- **Agent ID:** `2d5e7006-6ce1-4877-9dc1-563d2899f30a`
...
<script
  ...
  data-agent-id="2d5e7006-6ce1-4877-9dc1-563d2899f30a"
  data-api-key="a2a_your_key_here"
  data-title="Daily Weather Reporter"
></script>
```
